...
$user_query = mysqli_query(
    $conn,
    "SELECT * FROM users2 WHERE id = $user_id"
);

if (!$user_query) {
    die("Error users2: " . mysqli_error($conn));
}
...
if (!$pemesanan_query) {
    die("Error pemesanan2: " . mysqli_error($conn));
}
?>
...
.btn-group a:hover {
  ...
  box-shadow: 0 6px 18px rgba(255,215,0,.6);
  color: #000;
}
...
Belum ada riwayat pemesanan yang aktif atau selesai.
